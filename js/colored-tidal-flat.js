...
const frame = geo.rectangle(15, 9);
translate(frame, pt(0.162, -1.729))

removeOutsidePolylines(sky, frame[0]);
removeOutsidePolylines(ground, frame[0]);
removeOutsidePolylines(grass, frame[0]);

translate(final, pt(15.75/2, 6.593));
