...
geo.translate(circle, pt(7.074, 5.619));
...
bulb(pt(14.64, 2.944), 0.03, 1000);


const startPt = pt(0.466, 0.449);

cast(startPt, pt(5.736, 7.28), circle[0], 0.03, 1000);
cast(startPt, pt(7.812, 3.22), circle[0], 0.03, 1000);
cast(startPt, pt(4.425, 7.241), circle[0], 0.03, 1000);
cast(startPt, pt(7.397, 4.051), circle[0], 0.03, 1000);
